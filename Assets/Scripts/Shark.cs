...
public class Shark : Animal
{
    ...
    [SerializeField] private bool isBetterNet;  // A net better than random
    [SerializeField] private bool isIdealNet;  // The perfect starting net
    ...
    void Awake()
    {
        ...
        {
            HuntingSystem.layers[1].weights[0, 0] = 0.85f;
            HuntingSystem.layers[1].weights[0, 1] = 0.15f;
            HuntingSystem.layers[1].weights[1, 0] = 0.15f;
            HuntingSystem.layers[1].weights[1, 1] = 0.85f;
        }
